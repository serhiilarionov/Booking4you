...
export { CompanyListComponent } from './company/company-list.component';
export { CompanyCardComponent } from './company/company-card.component';
export { HeroComponent } from './hero/hero.component';
export { GmapComponent } from './gmap/gmap.component';

export const Components: Array<any> = [
  LoginFormComponent, RegistrationFormComponent, CompanyListComponent, HeroComponent, GmapComponent, CompanyCardComponent
];
