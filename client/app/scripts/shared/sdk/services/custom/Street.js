 ...
 */
var StreetApi = (function (_super) {
    __extends(StreetApi, _super);
    function StreetApi(http, auth, searchParams, errorHandler) {
     ...
     * </em>
     */
    StreetApi.prototype.getStreetType = function (id, refresh) {
     ...
     * </em>
     */
    StreetApi.prototype.findByIdBuildings = function (id, fk) {
        var method = "GET";
        var url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
        ...
        var urlParams = {};
        var result = this.request(method, url, routeParams, urlParams, postBody);
        return result.map(function (instance) { return new Street_1.Street(instance); });
    };
    /**
     ...
     */
    StreetApi.prototype.destroyByIdBuildings = function (id, fk) {
        var method = "DELETE";
        var url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/streets/:id/buildings/:fk";
        var routeParams = {
     ...
     * </em>
     */
    StreetApi.prototype.updateByIdBuildings = function (id, fk, data) {
     ...
     * </em>
     */
    StreetApi.prototype.getBuildings = function (id, filter) {
     ...
     * </em>
     */
    StreetApi.prototype.createBuildings = function (id, data) {
        if (data === void 0) { data = undefined; }
        var method = "POST";
        var url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/streets/:id/buildings";
     ...
     * This method returns no data.
     */
    StreetApi.prototype.deleteBuildings = function (id) {
        var method = "DELETE";
        var url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/streets/:id/buildings";
        var routeParams = {
     ...
     *  - `count` – `{number}` -
     */
    StreetApi.prototype.countBuildings = function (id, where) {
     ...
     * </em>
     */
    StreetApi.prototype.create = function (data) {
        if (data === void 0) { data = undefined; }
        var method = "POST";
        var url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/streets";
     ...
     * </em>
     */
    StreetApi.prototype.upsert = function (data) {
        if (data === void 0) { data = undefined; }
        var method = "PUT";
        var url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/streets";
     ...
     * </em>
     */
    StreetApi.prototype.replaceOrCreate = function (data) {
        if (data === void 0) { data = undefined; }
        var method = "POST";
        var url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
     ...
     * </em>
     */
    StreetApi.prototype.upsertWithWhere = function (where, data) {
        if (where === void 0) { where = undefined; }
        if (data === void 0) { data = undefined; }
        var method = "POST";
        var url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/streets/upsertWithWhere";
        var routeParams = {};
        var postBody = {
            data: data
        };
     ...
     *  - `exists` – `{boolean}` -
     */
    StreetApi.prototype.exists = function (id) {
        var method = "GET";
        var url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/streets/:id/exists";
        var routeParams = {
     ...
     * </em>
     */
    StreetApi.prototype.findById = function (id, filter) {
        if (filter === void 0) { filter = undefined; }
        var method = "GET";
        var url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/streets/:id";
     ...
     * </em>
     */
    StreetApi.prototype.replaceById = function (id, data) {
        if (data === void 0) { data = undefined; }
        var method = "POST";
        var url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/streets/:id/replace";
     ...
     * </em>
     */
    StreetApi.prototype.find = function (filter) {
        if (filter === void 0) { filter = undefined; }
        var method = "GET";
        var url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/streets";
        ...
        return result.map(function (instances) {
            return instances.map(function (instance) { return new Street_1.Street(instance); });
        });
    };
    /**
     ...
     * </em>
     */
    StreetApi.prototype.findOne = function (filter) {
        if (filter === void 0) { filter = undefined; }
        var method = "GET";
        var url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/streets/findOne";
     ...
     */
    StreetApi.prototype.updateAll = function (where, data) {
        if (where === void 0) { where = undefined; }
        if (data === void 0) { data = undefined; }
        var method = "POST";
        var url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
     ...
     * </em>
     */
    StreetApi.prototype.deleteById = function (id) {
        var method = "DELETE";
        var url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/streets/:id";
        var routeParams = {
     ...
     *  - `count` – `{number}` -
     */
    StreetApi.prototype.count = function (where) {
        if (where === void 0) { where = undefined; }
        var method = "GET";
        var url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/streets/count";
     ...
     * </em>
     */
    StreetApi.prototype.createManyBuildings = function (id, data) {
        if (data === void 0) { data = undefined; }
        var method = "POST";
        var url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/streets/:id/buildings";
     ...
     * </em>
     */
    StreetApi.prototype.createMany = function (data) {
        if (data === void 0) { data = undefined; }
        var method = "POST";
        var url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/streets";
     ...
     * i.e. `Street`.
     */
    StreetApi.prototype.getModelName = function () {
        return "Street";
    };
    StreetApi = __decorate([
        core_1.Injectable(),
