...
export class RegionApi extends BaseLoopBackApi {
   ...
   * </em>
   */
  public findByIdCities(id: any, fk: any) {
    ...
    return result.map((instance: Region) => new Region(instance));
  }
   ...
   */
  public destroyByIdCities(id: any, fk: any) {
   ...
   * </em>
   */
  public updateByIdCities(id: any, fk: any, data: any = undefined) {
   ...
   * </em>
   */
  public getCities(id: any, filter: LoopBackFilter = undefined) {
    let method: string = "GET";
    let url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/regions/:id/cities";
    let routeParams: any = {
   ...
   * </em>
   */
  public createCities(id: any, data: any = undefined) {
   ...
   *  - `count` – `{number}` - 
   */
  public countCities(id: any, where: any = undefined) {
    let method: string = "GET";
    let url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
  ...
  public find(filter: LoopBackFilter = undefined) {
    ...
    if (filter) urlParams.filter = filter;
    let result = this.request(method, url, routeParams, urlParams, postBody);
    return result.map((instances: Array<Region>) =>
        instances.map((instance: Region) => new Region(instance))
    );
  }
   ...
   * </em>
   */
  public createManyCities(id: any, data: Array<any> = undefined) {
    let method: string = "POST";
    let url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/regions/:id/cities";
    let routeParams: any = {
