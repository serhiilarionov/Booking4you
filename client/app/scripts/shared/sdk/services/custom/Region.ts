...
export class RegionApi extends BaseLoopBackApi {
   ...
   * </em>
   */
  public updateByIdCities(id: any, fk: any, data: City = undefined) {
   ...
   * </em>
   */
  public createCities(id: any, data: City = undefined) {
   ...
   * </em>
   */
  public createManyCities(id: any, data: City = undefined) {
    let method: string = "POST";
    let url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/regions/:id/cities";
    let routeParams: any = {
