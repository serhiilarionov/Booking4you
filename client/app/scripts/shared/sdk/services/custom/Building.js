...
/**
 * Api services for the `Building` model.
 */
var BuildingApi = (function (_super) {
    __extends(BuildingApi, _super);
    function BuildingApi(http, auth, searchParams, errorHandler) {
     ...
     * </em>
     */
    BuildingApi.prototype.create = function (data) {
        ...
        return result.map(function (instance) { return new Building_1.Building(instance); });
    };
    /**
     ...
     * </em>
     */
    BuildingApi.prototype.upsert = function (data) {
        if (data === void 0) { data = undefined; }
        var method = "PUT";
        var url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/buildings";
     ...
     * </em>
     */
    BuildingApi.prototype.replaceOrCreate = function (data) {
        if (data === void 0) { data = undefined; }
        var method = "POST";
        var url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/buildings/replaceOrCreate";
        var routeParams = {};
        var postBody = {
            data: data
        };
     ...
     * </em>
     */
    BuildingApi.prototype.upsertWithWhere = function (where, data) {
        if (where === void 0) { where = undefined; }
        if (data === void 0) { data = undefined; }
        var method = "POST";
        var url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/buildings/upsertWithWhere";
        var routeParams = {};
        var postBody = {
            data: data
        };
     ...
     *  - `exists` – `{boolean}` -
     */
    BuildingApi.prototype.exists = function (id) {
        var method = "GET";
        var url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/buildings/:id/exists";
        var routeParams = {
     ...
     * </em>
     */
    BuildingApi.prototype.findById = function (id, filter) {
     ...
     * </em>
     */
    BuildingApi.prototype.replaceById = function (id, data) {
        if (data === void 0) { data = undefined; }
        var method = "POST";
        var url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/buildings/:id/replace";
        var routeParams = {
            id: id
        };
        var postBody = {
     ...
     * </em>
     */
    BuildingApi.prototype.find = function (filter) {
        if (filter === void 0) { filter = undefined; }
        var method = "GET";
        var url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/buildings";
        ...
        return result.map(function (instances) {
            return instances.map(function (instance) { return new Building_1.Building(instance); });
        });
    };
    /**
     ...
     * </em>
     */
    BuildingApi.prototype.findOne = function (filter) {
        if (filter === void 0) { filter = undefined; }
        var method = "GET";
        var url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/buildings/findOne";
     ...
     */
    BuildingApi.prototype.updateAll = function (where, data) {
        if (where === void 0) { where = undefined; }
        if (data === void 0) { data = undefined; }
        var method = "POST";
        var url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
     ...
     * </em>
     */
    BuildingApi.prototype.deleteById = function (id) {
        var method = "DELETE";
        var url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/buildings/:id";
        var routeParams = {
     ...
     *  - `count` – `{number}` -
     */
    BuildingApi.prototype.count = function (where) {
        if (where === void 0) { where = undefined; }
        var method = "GET";
        var url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/buildings/count";
     ...
     * </em>
     */
    BuildingApi.prototype.createMany = function (data) {
        if (data === void 0) { data = undefined; }
        var method = "POST";
        var url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/buildings";
     ...
     * i.e. `Building`.
     */
    BuildingApi.prototype.getModelName = function () {
        return "Building";
    };
    BuildingApi = __decorate([
        core_1.Injectable(),
