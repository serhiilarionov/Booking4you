...
import { CommentQuestion } from '../../models/CommentQuestion';
 ...
 */
@Injectable()
export class CommentQuestionApi extends BaseLoopBackApi {
   ...
   * </em>
   */
  public getQuestion(id: any, refresh: any = undefined) {
    let method: string = "GET";
    let url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
  ...
  public create(data: any = undefined) {
    ...
    let urlParams: any = {};
    let result = this.request(method, url, routeParams, urlParams, postBody);
    return result.map((instance: CommentQuestion) => new CommentQuestion(instance));
  }
  ...
  public find(filter: LoopBackFilter = undefined) {
    ...
    if (filter) urlParams.filter = filter;
    let result = this.request(method, url, routeParams, urlParams, postBody);
    return result.map((instances: Array<CommentQuestion>) =>
        instances.map((instance: CommentQuestion) => new CommentQuestion(instance))
    );
  }
