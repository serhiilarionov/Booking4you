...
var QuestionApi = (function (_super) {
    ...
    function QuestionApi(http, auth, searchParams, errorHandler) {
     ...
     * </em>
     */
    QuestionApi.prototype.create = function (data) {
        ...
        return result.map(function (instance) { return new Question_1.Question(instance); });
    };
    /**
     ...
     * </em>
     */
    QuestionApi.prototype.upsert = function (data) {
        if (data === void 0) { data = undefined; }
        var method = "PUT";
        var url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/Question";
     ...
     * </em>
     */
    QuestionApi.prototype.replaceOrCreate = function (data) {
        if (data === void 0) { data = undefined; }
        var method = "POST";
        var url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/Question/replaceOrCreate";
        var routeParams = {};
        var postBody = {
            data: data
        };
     ...
     * </em>
     */
    QuestionApi.prototype.upsertWithWhere = function (where, data) {
        if (where === void 0) { where = undefined; }
        if (data === void 0) { data = undefined; }
        var method = "POST";
        var url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/Question/upsertWithWhere";
        var routeParams = {};
        var postBody = {
            data: data
        };
     ...
     *  - `exists` – `{boolean}` -
     */
    QuestionApi.prototype.exists = function (id) {
        var method = "GET";
        var url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/Question/:id/exists";
        var routeParams = {
     ...
     * </em>
     */
    QuestionApi.prototype.findById = function (id, filter) {
     ...
     * </em>
     */
    QuestionApi.prototype.replaceById = function (id, data) {
        if (data === void 0) { data = undefined; }
        var method = "POST";
        var url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/Question/:id/replace";
     ...
     * </em>
     */
    QuestionApi.prototype.find = function (filter) {
        if (filter === void 0) { filter = undefined; }
        var method = "GET";
        var url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/Question";
        ...
        return result.map(function (instances) {
            return instances.map(function (instance) { return new Question_1.Question(instance); });
        });
    };
    /**
     ...
     * </em>
     */
    QuestionApi.prototype.findOne = function (filter) {
        if (filter === void 0) { filter = undefined; }
        var method = "GET";
        var url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/Question/findOne";
     ...
     */
    QuestionApi.prototype.updateAll = function (where, data) {
        if (where === void 0) { where = undefined; }
        if (data === void 0) { data = undefined; }
        var method = "POST";
        var url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
     ...
     * </em>
     */
    QuestionApi.prototype.deleteById = function (id) {
        var method = "DELETE";
        var url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/Question/:id";
        var routeParams = {
     ...
     *  - `count` – `{number}` -
     */
    QuestionApi.prototype.count = function (where) {
        if (where === void 0) { where = undefined; }
        var method = "GET";
        var url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/Question/count";
     ...
     * </em>
     */
    QuestionApi.prototype.createMany = function (data) {
        if (data === void 0) { data = undefined; }
        var method = "POST";
        var url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/Question";
