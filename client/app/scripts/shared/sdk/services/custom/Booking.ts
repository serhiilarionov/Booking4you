...
export class BookingApi extends BaseLoopBackApi {
   ...
   * </em>
   */
  public linkServices(id: any, fk: any, data: any = undefined) {
    let method: string = "PUT";
    let url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
   ...
   * This method returns no data.
   */
  public unlinkServices(id: any, fk: any) {
    let method: string = "DELETE";
    let url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/bookings/:id/services/rel/:fk";
    let routeParams: any = {
   ...
   * </em>
   */
  public existsServices(id: any, fk: any) {
   ...
   * </em>
   */
  public getComment(id: any, refresh: any = undefined) {
    let method: string = "GET";
    let url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/bookings/:id/comment";
    let routeParams: any = {
   ...
   * </em>
   */
  public createComment(id: any, data: any = undefined) {
   ...
   * </em>
   */
  public updateComment(id: any, data: any = undefined) {
    let method: string = "PUT";
    let url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/bookings/:id/comment";
    let routeParams: any = {
  ...
  public find(filter: LoopBackFilter = undefined) {
    ...
    if (filter) urlParams.filter = filter;
    let result = this.request(method, url, routeParams, urlParams, postBody);
    return result.map((instances: Array<Booking>) =>
   ...
   * </em>
   */
  public createManyComment(id: any, data: Array<any> = undefined) {
    let method: string = "POST";
    let url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/bookings/:id/comment";
    let routeParams: any = {
