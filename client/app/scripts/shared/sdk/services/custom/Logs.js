...
/**
 * Api services for the `Logs` model.
 */
var LogsApi = (function (_super) {
    __extends(LogsApi, _super);
    function LogsApi(http, auth, searchParams, errorHandler) {
     ...
     * </em>
     */
    LogsApi.prototype.create = function (data) {
        ...
        return result.map(function (instance) { return new Logs_1.Logs(instance); });
    };
    /**
     ...
     * </em>
     */
    LogsApi.prototype.upsert = function (data) {
        if (data === void 0) { data = undefined; }
        var method = "PUT";
        var url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/logs";
     ...
     * </em>
     */
    LogsApi.prototype.replaceOrCreate = function (data) {
        if (data === void 0) { data = undefined; }
        var method = "POST";
        var url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/logs/replaceOrCreate";
        var routeParams = {};
        var postBody = {
            data: data
        };
     ...
     * </em>
     */
    LogsApi.prototype.upsertWithWhere = function (where, data) {
        if (where === void 0) { where = undefined; }
        if (data === void 0) { data = undefined; }
        var method = "POST";
        var url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/logs/upsertWithWhere";
        var routeParams = {};
        var postBody = {
            data: data
        };
     ...
     *  - `exists` – `{boolean}` -
     */
    LogsApi.prototype.exists = function (id) {
        var method = "GET";
        var url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/logs/:id/exists";
        var routeParams = {
     ...
     * </em>
     */
    LogsApi.prototype.findById = function (id, filter) {
     ...
     * </em>
     */
    LogsApi.prototype.replaceById = function (id, data) {
        if (data === void 0) { data = undefined; }
        var method = "POST";
        var url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/logs/:id/replace";
     ...
     * </em>
     */
    LogsApi.prototype.find = function (filter) {
        if (filter === void 0) { filter = undefined; }
        var method = "GET";
        var url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/logs";
        ...
        return result.map(function (instances) {
            return instances.map(function (instance) { return new Logs_1.Logs(instance); });
        });
    };
    /**
     ...
     * </em>
     */
    LogsApi.prototype.findOne = function (filter) {
        if (filter === void 0) { filter = undefined; }
        var method = "GET";
        var url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/logs/findOne";
     ...
     */
    LogsApi.prototype.updateAll = function (where, data) {
        if (where === void 0) { where = undefined; }
        if (data === void 0) { data = undefined; }
        var method = "POST";
        var url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
     ...
     * </em>
     */
    LogsApi.prototype.deleteById = function (id) {
        var method = "DELETE";
        var url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/logs/:id";
        var routeParams = {
     ...
     *  - `count` – `{number}` -
     */
    LogsApi.prototype.count = function (where) {
        if (where === void 0) { where = undefined; }
        var method = "GET";
        var url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/logs/count";
     ...
     * </em>
     */
    LogsApi.prototype.updateAttributes = function (id, data) {
        if (data === void 0) { data = undefined; }
        var method = "PUT";
        var url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/logs/:id";
     ...
     */
    LogsApi.prototype.createChangeStream = function () {
        var url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/logs/change-stream";
     ...
     * </em>
     */
    LogsApi.prototype.createMany = function (data) {
        if (data === void 0) { data = undefined; }
        var method = "POST";
        var url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/logs";
     ...
     * i.e. `Logs`.
     */
    LogsApi.prototype.getModelName = function () {
        return "Logs";
    };
    LogsApi = __decorate([
        core_1.Injectable(),
