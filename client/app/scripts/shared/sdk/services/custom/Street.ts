...
export class StreetApi extends BaseLoopBackApi {
   ...
   * </em>
   */
  public updateByIdBuildings(id: any, fk: any, data: any = undefined) {
   ...
   * </em>
   */
  public createBuildings(id: any, data: any = undefined) {
   ...
   * </em>
   */
  public createManyBuildings(id: any, data: Array<any> = undefined) {
    let method: string = "POST";
    let url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/streets/:id/buildings";
    let routeParams: any = {
