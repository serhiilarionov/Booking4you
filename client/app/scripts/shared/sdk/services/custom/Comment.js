...
var CommentApi = (function (_super) {
    ...
    function CommentApi(http, auth, searchParams, errorHandler) {
     ...
     * </em>
     */
    CommentApi.prototype.getCompany = function (id, refresh) {
     ...
     * </em>
     */
    CommentApi.prototype.getBooking = function (id, refresh) {
        if (refresh === void 0) { refresh = undefined; }
        var method = "GET";
        var url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/Comment/:id/booking";
     ...
     * </em>
     */
    CommentApi.prototype.getUser = function (id, refresh) {
        if (refresh === void 0) { refresh = undefined; }
        var method = "GET";
        var url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/Comment/:id/user";
     ...
     * </em>
     */
    CommentApi.prototype.create = function (data) {
        ...
        var urlParams = {};
        var result = this.request(method, url, routeParams, urlParams, postBody);
        return result.map(function (instance) { return new Comment_1.Comment(instance); });
    };
    /**
     ...
     * </em>
     */
    CommentApi.prototype.upsert = function (data) {
        if (data === void 0) { data = undefined; }
        var method = "PUT";
        var url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/Comment";
     ...
     * </em>
     */
    CommentApi.prototype.replaceOrCreate = function (data) {
        if (data === void 0) { data = undefined; }
        var method = "POST";
        var url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
     ...
     * </em>
     */
    CommentApi.prototype.upsertWithWhere = function (where, data) {
     ...
     *  - `exists` – `{boolean}` -
     */
    CommentApi.prototype.exists = function (id) {
        var method = "GET";
        var url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/Comment/:id/exists";
        var routeParams = {
     ...
     * </em>
     */
    CommentApi.prototype.findById = function (id, filter) {
     ...
     * </em>
     */
    CommentApi.prototype.replaceById = function (id, data) {
        if (data === void 0) { data = undefined; }
        var method = "POST";
        var url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/Comment/:id/replace";
     ...
     * </em>
     */
    CommentApi.prototype.find = function (filter) {
        if (filter === void 0) { filter = undefined; }
        var method = "GET";
        var url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/Comment";
        ...
        return result.map(function (instances) {
            return instances.map(function (instance) { return new Comment_1.Comment(instance); });
        });
    };
    /**
     ...
     * </em>
     */
    CommentApi.prototype.findOne = function (filter) {
        if (filter === void 0) { filter = undefined; }
        var method = "GET";
        var url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/Comment/findOne";
     ...
     */
    CommentApi.prototype.updateAll = function (where, data) {
        if (where === void 0) { where = undefined; }
        if (data === void 0) { data = undefined; }
        var method = "POST";
        var url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
     ...
     * </em>
     */
    CommentApi.prototype.deleteById = function (id) {
        var method = "DELETE";
        var url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/Comment/:id";
        var routeParams = {
     ...
     *  - `count` – `{number}` -
     */
    CommentApi.prototype.count = function (where) {
        if (where === void 0) { where = undefined; }
        var method = "GET";
        var url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/Comment/count";
     ...
     * </em>
     */
    CommentApi.prototype.createMany = function (data) {
        if (data === void 0) { data = undefined; }
        var method = "POST";
        var url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/Comment";
     ...
     * i.e. `Comment`.
     */
    CommentApi.prototype.getModelName = function () {
        return "Comment";
    };
